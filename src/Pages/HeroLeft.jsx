    ...
    return (
        <div className='w-1/2 flex flex-col justify-center items-center pt-[5rem] pb-[10rem]'>
            ...
            <div className='flex gap-10 mt-[4rem]'>
                ...
                <button onClick={()=> {navigate('/about'); scrollTo(0,0)}} className='hover:scale-95 py-2 px-6 text-[0.8rem] font-semibold bg-white border-2 border-[#0066CD] text-[#0066CD]'>READ MORE</button>
            </div>
        </div>
    )
}
